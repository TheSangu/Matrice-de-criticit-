...
- [x] **Contacts / liens réels** intégrés depuis les affichages agence : Céla (0 805 389 958, service-ecoute@qualisocial.com), process incivilité (base Incidents ServiceNow + alerte DRH `alerte-oc@groupama-oc.fr`), médecine du travail MSA et RH/RPS (chemins Coll'OC), secours (15/17/18/112)
